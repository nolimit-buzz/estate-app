...
?>
<aside class="sidebar" style="background: #0f172a; min-height: calc(100vh - 60px);">
    <nav class="sidebar-nav mt-3">
        <ul>
            <li class="nav-label text-slate-400 px-3 py-2 text-uppercase fw-semibold" style="font-size: 0.75rem; letter-spacing: 0.05em;">Staff Console</li>
            <li>
            ...
            <?php if (hasPermission('visitors.view_log') || hasPermission('visitors.check_in_out') || hasPermission('visitors.emergency_alerts')): ?>
